export const DockerIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <rect width="48" height="48" x="6" y="6" rx="2" />
    <path
      fill="#03A9F4"
...
export const CSharpIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
    <rect width="48" height="48" x="6" y="6" rx="2" fill="none" />
    <path
      fill="#37474f"
      fillRule="evenodd"
      d="M22.903,3.286c0.679-0.381,1.515-0.381,2.193,0 c3.355,1.883,13.451,7.551,16.807,9.434C42.582,13.1,43,13.804,43,14.566c0,3.766,0,15.101,0,18.867 c0,0.762-0.418,1.466-1.097,1.847c-3.355,1.883-13.451,7.551-16.807,9.434c-0.679,0.381-1.515,0.381-2.193,0 c-3.355-1.883-13.451-7.551-16.807-9.434C5.418,34.899,5,34.196,5,33.434c0-3.766,0-15.101,0-18.867 c0-0.762,0.418-1.466,1.097-1.847C9.451,10.837,19.549,5.169,22.903,3.286z"
...
export const TypeScriptIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <rect width="48" height="48" x="6" y="6" fill="#1976d2" rx="2" />
    <path
      fill="currentColor"
      d="M27.49 22H14.227v3.264H18.984V40h3.769V25.264H27.49V22z"
    />
    <path
      fill="currentColor"
      d="M39.194 26.084s-1.787-1.192-3.807-1.192-2.747.96-2.747 1.986c0 2.648 7.381 2.383 7.381 7.712 0 8.209-11.254 4.568-11.254 4.568V35.22s2.152 1.622 4.733 1.622 2.483-1.688 2.483-1.92c0-2.449-7.315-2.449-7.315-7.878 0-7.381 10.658-4.469 10.658-4.469z"
      opacity="0.95"
    />
  </svg>
);
